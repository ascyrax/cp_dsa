...
void before()
{
  ...
  // dp[i]=total no of ways to form palindromic sum of i.

  // for (int i = 1; i <= n; i++)
  // {
  //   if (m.count(i) > 0 && m.count(n - i) > 0)
  //   {
  //   }
  // }
