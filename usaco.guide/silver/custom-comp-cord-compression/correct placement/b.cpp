...
void suraj()
{
        ...
        for (int i = 0; i < n; i++)
        {
                ...
                if (loc == vp.end())
                {
                        ...
                        if ((*loc).first.first < current.first.first && (*loc).first.second < current.first.second)
                        {
                                if ((*loc).second != current.second)
                                {
                                        ans[current.second] = (*loc).second;
                                }
                                else
                                {
                                }
                ...
                else if ((*loc).first.first < current.first.first || (*loc).first.second < current.first.second)
                {
                        ans[current.second] = (*loc).second;
                }
                else
